...
public class TFIDFCalculator {
	...
	public double calculateDocumentTfIdf(String document) {
		...
		if (wordList.isEmpty() || (wordList.size() == 1 && wordList.get(0).isEmpty())) {
			return 0.0;
		}
	...
	// calculator.addDocumentToCorpus("ٱللَّهُ لَآ إِلَـٰهَ إِلَّا هُوَ ٱلْحَىُّ
	// ٱلْقَيُّومُ ۚ لَا تَأْخُذُهُۥ سِنَةٌۭ وَلَا نَوْمٌۭ ۚ لَّهُۥ مَا فِى
	// ٱلسَّمَـٰوَٰتِ وَمَا فِى ٱلْأَرْضِ ۗ مَن ذَا ٱلَّذِى يَشْفَعُ عِندَهُۥٓ
	// إِلَّا بِإِذْنِهِۦ ۚ يَعْلَمُ مَا بَيْنَ أَيْدِيهِمْ وَمَا خَلْفَهُمْ ۖ وَلَا
	// يُحِيطُونَ بِشَىْءٍۢ مِّنْ عِلْمِهِۦٓ إِلَّا بِمَا شَآءَ ۚ وَسِعَ
	// كُرْسِيُّهُ ٱلسَّمَـٰوَٰتِ وَٱلْأَرْضَ ۖ وَلَا يَـُٔودُهُۥ حِفْظُهُمَا ۚ
	// وَهُوَ ٱلْعَلِىُّ ٱلْعَظِيمُ");
	// calculator.addDocumentToCorpus("مرحبًا، اسمي (اسمك). ولدت ونشأت في مدينة
	// (مدينتك) الجميلة. أنا طالب/ة في (اسم مدرستك أو جامعتك) وأدرس (تخصصك الدراسي).
	// منذ صغري وأنا أحب (أحد اهتماماتك أو هواياتك). لقد أمضيت الكثير من الوقت في
	// تعلم وممارسة هذه الهواية لأنها تمنحني شعورًا بالراحة والسعادة. "
	// + "بالإضافة إلى الدراسة، أحب قضاء وقت فراغي في القيام بأشياء أخرى مثل (أحد
	// الأنشطة التي تستمتع بها). هذا النشاط ليس فقط ممتعًا بالنسبة لي ولكنه أيضًا
	// يساعدني في تنمية مهاراتي مثل (اذكر المهارات التي طورتها من خلال هذا النشاط).
	// "
	// + "أحب أيضًا القراءة والمطالعة. الكتب تمثل لي نافذة للعالم، وأنا أحب قراءة
	// أنواع مختلفة من الكتب مثل (نوع الكتب التي تقرأها). كل كتاب أقرأه يساعدني على
	// التعرف على أشياء جديدة وتوسيع آفاقي. "
	// + "أسرتي هي جزء مهم من حياتي. نحن أسرة مترابطة وندعم بعضنا البعض دائمًا. لقد
	// تعلمت من عائلتي قيمًا مهمة مثل الاحترام، والتفاني، والعمل الجاد. هؤلاء القيم
	// تساعدني في كل ما أقوم به في حياتي. "
	// + "أطمح في المستقبل إلى (اذكر أحلامك وطموحاتك المستقبلية). أنا أؤمن أن العمل
	// الجاد والتفاني سيجلب لي النجاح في كل ما أسعى إليه. أنا متحمس/ة لتحقيق أحلامي
	// وأهدافي وآمل أن أترك بصمة إيجابية في العالم.");
	//
	...
	// "فَبِأَيِّ آلَاءِ رَبِّكُمَا تُكَذِّبَانِ " +
	// "يَا مَعْشَرَ الْجِنِّ وَالْإِنسِ إِنِ اسْتَطَعْتُمْ أَنْ تَنْفُذُوا مِنْ
	// أَقْطَارِ السَّمَاوَاتِ وَالْأَرْضِ فَانْفُذُوا لَا تَنْفُذُونَ إِلَّا
	// بِسُلْطَانٍ " +
	// "فَبِأَيِّ آلَاءِ رَبِّكُمَا تُكَذِّبَانِ " +
	...
	// "فَبِأَيِّ آلَاءِ رَبِّكُمَا تُكَذِّبَانِ " +
	// "مُتَّكِئِينَ عَلَىٰ فُرُشٍ بَطَائِنُهَا مِنْ إِسْتَبْرَقٍ وَجَنَى
	// الْجَنَّتَيْنِ دَانٍ " +
	// "فَبِأَيِّ آلَاءِ رَبِّكُمَا تُكَذِّبَانِ " +
	// "فِيهِنَّ قَاصِرَاتُ الطَّرْفِ لَمْ يَطْمِثْهُنَّ إِنْسٌ قَبْلَهُمْ وَلَا
	// جَانٌّ " +
	// "فَبِأَيِّ آلَاءِ رَبِّكُمَا تُكَذِّبَانِ " +
